...
$search = $DB->prepare("SELECT DISTINCT * FROM medservice JOIN players ON medservice.name = players.name WHERE players.name LIKE :search_value ORDER BY id DESC LIMIT 0, 200");
...
?>
    <header class="row m-3">
        <div class="col-md align-content-center">
            <h2 class="text-center display-4">Sapeurs-Pompiers - Service</h2>
        </div>
    </header>
