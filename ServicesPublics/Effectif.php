<?php
include '../init.php';
$search = $DB->query("SELECT DISTINCT * FROM players WHERE publique != '0' ORDER BY publique DESC, name ASC");
include '../templates/top.php';
?>
    <header class="row m-3">
        <div class="col-md align-content-center">
            <h2 class="text-center display-4">Services Publics <span class="badge badge-dark"><?= $search->rowCount() ?></span></h2>
        </div>
    </header>
    <div class="row">
        <div class="col">
