...
$search = $DB->prepare("SELECT DISTINCT * FROM logs_alf JOIN players ON logs_alf.name = players.name WHERE logs_alf.type = 'SERVICE' AND players.name LIKE :search_value AND text LIKE '%service.' ORDER BY id DESC LIMIT 0, 200");
...
?>
    <header class="row m-3">
        <div class="col-md align-content-center">
            <h2 class="text-center display-4">Services Publics - Service</h2>
        </div>
    </header>
